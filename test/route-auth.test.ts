...
const PROTECTED: { method: string; path: string; body?: object }[] = [
  ...
  { method: 'POST', path: '/api/council/converse/start', body: { topic: 't', members: ['zen-ai'] } },
  { method: 'GET',  path: '/api/council/convos' },
  { method: 'GET',  path: '/api/council/member/zen-ai/brain' },
