...
const PROTECTED: { method: string; path: string; body?: object }[] = [
  ...
  { method: 'GET',  path: '/api/council/whoami' },
  ...
  { method: 'GET',  path: '/api/bridge/corpus-contract' },
  { method: 'GET',  path: '/api/council/response-shapes' },
  ...
  { method: 'GET',  path: '/api/council/transfers?to_machine=probe' },
  { method: 'GET',  path: '/api/council/transfer/route-auth-probe-id' },
  ...
  { method: 'GET',  path: '/api/council/limits' },
  { method: 'POST', path: '/api/council/limits', body: { turnTarget: 50, usdCeiling: 4 } },
  ...
  { method: 'POST', path: '/api/council/story', body: { content: 'probe story' } },
  { method: 'GET',  path: '/api/council/story' },
  { method: 'POST', path: '/api/council/commitments', body: { title: 't', forActors: ['kairos'] } },
  { method: 'GET',  path: '/api/council/commitments/ledger' },
  { method: 'GET',  path: '/api/council/commitments' },
  { method: 'POST', path: '/api/council/commitments/route-auth-probe-id/decide', body: { status: 'accepted' } },
  { method: 'POST', path: '/api/council/commitments/route-auth-probe-id/implement', body: { evidence: { commitSha: 'abc' } } },
  { method: 'POST', path: '/api/council/commitments/route-auth-probe-id/verify', body: {} },
